...
// let trois = document.querySelectorAll('.important');
// // console.log(trois);

// let cinq = document.querySelectorAll('.important');

// // 6
// let six = document.getElementById("content");
// let grandParagraphes = six.getElementsByClassName("grandParagraphe");
// let dernier = grandParagraphes;
// console.log(dernier);
